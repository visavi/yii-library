...
class BookController extends Controller
{
	...
	public function actionView($id)
	{
		$this->render('view',array(
			'model'=>$this->loadModel($id)->with('authors'),
		));
	}
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Book']))
		{
            ...
            $model->cover_image_file = CUploadedFile::getInstance($model, 'cover_image_file');

			if($model->save()) {
                $model->saveCoverImage();
                $model->saveAuthors($model->author_ids);
